    ...
    <div className="min-h-screen">
      ...
      <main>
        ...
        <section className="section-dark pt-32 pb-16 px-6 relative">
          <div className="glow-orb absolute top-1/3 -right-32 w-[400px] h-[400px] animate-glow-breathe" />
          <div className="max-w-7xl mx-auto text-center relative z-10">
            ...
            >
              ...
              >
                Explore global destinations and unforgettable experiences, from city tours and adventures to luxury and cultural journeys.
              </p>
            </motion.div>
          </div>
        </section>

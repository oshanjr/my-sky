            ...
            <div className="pt-6 mt-6 border-t border-white/10">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <div className="flex items-center justify-center bg-white/5 rounded-lg px-4 py-2 border border-white/10 h-10 hover:bg-white/10 transition-colors">
                  <span className="text-[#00c9e8] font-bold italic tracking-wider text-[17px] leading-none" style={{ fontFamily: 'Arial, sans-serif' }}>KOKO</span>
                </div>
                
                {/* MintPay */}
                <div className="flex items-center justify-center bg-white/5 rounded-lg px-4 py-2 border border-white/10 h-10 hover:bg-white/10 transition-colors">
                  <span className="text-[#3FFDD3] font-bold lowercase tracking-tight text-[15px] leading-none" style={{ fontFamily: 'system-ui, sans-serif' }}>mintpay</span>
                </div>
                
                {/* Global Cards */}
                <div className="flex items-center justify-center bg-white/5 rounded-lg px-4 py-2 border border-white/10 h-10 gap-3 hover:bg-white/10 transition-colors">
                  <svg width="32" height="11" viewBox="0 0 32 11" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-auto opacity-90">
                  ...
                  <img src="https://upload.wikimedia.org/wikipedia/commons/2/2a/Mastercard-logo.svg" alt="Mastercard" className="h-5 object-contain opacity-90" />
                  <img src="https://upload.wikimedia.org/wikipedia/commons/3/30/American_Express_logo.svg" alt="American Express" className="h-5 object-contain opacity-90" />
                </div>
              </div>
            </div>
          </div>
